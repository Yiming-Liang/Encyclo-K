...
def load_model(model_name="glm-4.6", base_url="", api_key="", model="", call_type='api_chat'):
    model_components = {}
...
if __name__ == '__main__':
    ...
    model_args = {
        ...
        'base_url': '',
        'api_key': 'e226b952f1c84ac4b098199eb27188df.uJrlEAEGFSJ65pDa',
        'model': 'glm-4.6',
        'call_type': 'api_chat'
        }
    ...
    model_components = load_model("glm-4.6", base_url=model_args['base_url'], api_key=model_args['api_key'], model=model_args['model'], call_type=model_args['call_type'])
